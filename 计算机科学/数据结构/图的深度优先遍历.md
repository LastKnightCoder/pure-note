...
<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/202010161552392022-04-23-13-31-06.gif" style="zoom:50%"/>

从上面的动图可以看出，当我们遍历完当前节点以后，如果该节点有孩子节点，那么接下来我们去遍历孩子节点，我们的遍历策略就是尽可能深的遍历。类比于图，对于图来说，如果一个图的节点有邻接节点，那么在遍历完该节点后，我们下一步就去遍历它的邻接节点

<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/202010161613102022-04-23-13-31-56.gif" style="zoom:50%"/>
...
<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/202204231334152022-04-23-13-34-15.png" style="zoom:50%"/>

既然图中有节点永远不会被访问到，那么还能叫图的遍历吗，图的遍历可是要求能够访问图中所有的节点的，所以我们对代码进行改进

<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/202204231334322022-04-23-13-34-32.png" style="zoom:50%"/>
...
<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/202010281027282022-04-23-13-35-11.gif" style="zoom:50%"/>
...
<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/202204231335592022-04-23-13-36-00.png" style="zoom:50%"/>
...
<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/GraphBasis-第 6 页.drawio2022-04-23-13-41-32.svg" style="zoom:50%"/>
...
<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/202010230021482022-04-23-13-43-03.gif" style="zoom:50%"/>

在上面我们从节点 $0$ 开始遍历，在遍历的过程中我们记录了当前节点之前的节点，最后得到这么一个结果

<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/202204231343242022-04-23-13-43-24.png" style="zoom:50%"/>

现在我们想知道节点 $0$ 是如何到达节点 $5$ 的，直接逆推就可以知道路径为 $5 \leftarrow 4 \leftarrow 2 \leftarrow 0$，如下

<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/202010230028062022-04-23-13-43-54.gif" style="zoom:50%"/>
...
<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/202010231036452022-04-23-13-45-50.gif" style="zoom:50%"/>
...
<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/202010272127012022-04-23-13-47-46.gif" style="zoom:50%"/>
...
<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/202204231354452022-04-23-13-54-45.png" style="zoom:50%"/>
...
<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/202204231355242022-04-23-13-55-25.png" style="zoom:50%"/>
...
<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/202204231356242022-04-23-13-56-24.png" style="zoom:50%"/>
