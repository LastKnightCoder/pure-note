...
<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/202204231444102022-04-23-14-44-10.png" style="zoom:50%"/>

这个图分为三部分，第一部分

<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/202204231445322022-04-23-14-45-33.png" style="zoom:50%"/>

其中权值表示比赛场次，比如 `s → NY-Bal` 这条边的权值为 $5$，表示 NY 与 Bal 之间有五场比赛要打，可见这四个队伍总共要打 $5 + 8 + 7 + 2 + 7 = 27$ 场比赛。第二部分

<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/202204231446262022-04-23-14-46-26.png" style="zoom:50%"/>

这次的权值表示的是胜场的分配。第三部分

<img src="https://cdn.jsdelivr.net/gh/LastKnightCoder/ImgHosting3@master/202204231447122022-04-23-14-47-13.png" style="zoom:50%"/>
