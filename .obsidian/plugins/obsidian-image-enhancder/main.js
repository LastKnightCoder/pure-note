        ...
        class Bottleneck3 {
          ...
          _free(index, job, options, eventInfo) {
            return __async(this, null, function* () {
              var e2, running;
              try {
                ({ running } = yield this._store.__free__(index, options.weight));
          ...
          _addToQueue(job) {
            return __async(this, null, function* () {
              ...
              ({ args, options } = job);
              try {
                ({ reachedHWM, blocked, strategy } = yield this._store.__submit__(this.queued(), options.weight));
              } catch (error1) {
                error = error1;
  ...
  "node_modules/@octokit/oauth-methods/dist-node/index.js"(exports) {
    ...
    function scopeToken(options) {
      return __async(this, null, function* () {
        ...
        const response = yield (request$1 || request.request)("POST /applications/{client_id}/token/scoped", _objectSpread2({
          headers: {
  ...
  "node_modules/@octokit/auth-oauth-device/dist-node/index.js"(exports) {
    ...
    function getOAuthAccessToken(state, options) {
      return __async(this, null, function* () {
        ...
        const {
          data: verification
        } = yield oauthMethods.createDeviceCode({
    ...
    function waitForAccessToken(request2, clientId, clientType, verification) {
      return __async(this, null, function* () {
        try {
          ...
          const {
            authentication
          } = clientType === "oauth-app" ? yield oauthMethods.exchangeDeviceCode(_objectSpread2(_objectSpread2({}, options), {}, {
            clientType: "oauth-app"
          })) : yield oauthMethods.exchangeDeviceCode(_objectSpread2(_objectSpread2({}, options), {}, {
            clientType: "github-app"
          }));
    ...
    function auth(state, authOptions) {
      return __async(this, null, function* () {
    ...
    function hook(state, request2, route, parameters) {
      return __async(this, null, function* () {
  ...
  "node_modules/@octokit/auth-oauth-user/dist-node/index.js"(exports) {
    ...
    function getAuthentication(state) {
      return __async(this, null, function* () {
        if ("code" in state.strategyOptions) {
          const {
            authentication
          } = yield oauthMethods.exchangeWebFlowCode(_objectSpread2(_objectSpread2({
            clientId: state.clientId,
      ...
      return __async(this, arguments, function* (state, options = {}) {
        ...
        if ("expiresAt" in currentAuthentication) {
          if (options.type === "refresh" || new Date(currentAuthentication.expiresAt) < new Date()) {
            const {
              authentication
            } = yield oauthMethods.refreshToken({
              clientType: "github-app",
              clientId: state.clientId,
              clientSecret: state.clientSecret,
    ...
    function hook(_0, _1, _2) {
      return __async(this, arguments, function* (state, request2, route, parameters = {}) {
        ...
        const {
          token
        } = state.clientType === "oauth-app" ? yield auth(_objectSpread2(_objectSpread2({}, state), {}, {
          request: request2
        })) : yield auth(_objectSpread2(_objectSpread2({}, state), {}, {
          request: request2
        }));
        endpoint.headers.authorization = "token " + token;
        return request2(endpoint);
  ...
  "node_modules/@octokit/auth-oauth-app/dist-node/index.js"(exports) {
    ...
    function auth(state, authOptions) {
      return __async(this, null, function* () {
        ...
        const userAuth = state.clientType === "oauth-app" ? yield authOauthUser.createOAuthUserAuth(_objectSpread2(_objectSpread2({}, common), {}, {
          clientType: state.clientType
        })) : yield authOauthUser.createOAuthUserAuth(_objectSpread2(_objectSpread2({}, common), {}, {
          clientType: state.clientType
        }));
        return userAuth();
      });
...
var require_dist_node15 = __commonJS({
  "node_modules/@octokit/auth-app/dist-node/index.js"(exports) {
    ...
    var deprecation = require_dist_node3();
    var universalGithubAppJwt = (init_index_bundled(), index_bundled_exports);
    ...
    function getAppAuthentication(_0) {
      return __async(this, arguments, function* ({
        ...
        try {
          const appAuthentication = yield universalGithubAppJwt.githubAppJwt({
            id: +appId,
            privateKey,
    ...
    function set(cache, options, data) {
      return __async(this, null, function* () {
    ...
    function getInstallationAuthentication(state, options, customRequest) {
      return __async(this, null, function* () {
        ...
        } = yield request2("POST /app/installations/{installation_id}/access_tokens", {
    ...
    function hook(state, request2, route, parameters) {
      return __async(this, null, function* () {
        ...
        if (requiresAppAuth(url.replace(request2.endpoint.DEFAULTS.baseUrl, ""))) {
          ...
          let response;
          try {
            response = yield request2(endpoint);
          } catch (error) {
            ...
            const {
              token: token3
            } = yield getAppAuthentication(_objectSpread2(_objectSpread2({}, state), {}, {
              timeDifference: diff
            }));
        ...
        const {
          token,
          createdAt
        } = yield getInstallationAuthentication(state, {}, request2);
        endpoint.headers.authorization = `token ${token}`;
...
var require_dist_node16 = __commonJS({
  "node_modules/@octokit/auth-unauthenticated/dist-node/index.js"(exports) {
    ...
    function hook(reason, request, route, parameters) {
      return __async(this, null, function* () {
        const endpoint = request.endpoint.merge(route, parameters);
  ...
  "node_modules/@octokit/oauth-app/dist-node/index.js"(exports) {
    ...
    function resetTokenWithState(state, options) {
      return __async(this, null, function* () {
        ...
        if (state.clientType === "oauth-app") {
          const response2 = yield OAuthMethods.resetToken(_objectSpread2({
            clientType: "oauth-app"
          }, optionsWithDefaults));
    ...
    function deleteTokenWithState(state, options) {
      return __async(this, null, function* () {
        ...
        const response = state.clientType === "oauth-app" ? yield OAuthMethods.deleteToken(_objectSpread2({
          clientType: "oauth-app"
        }, optionsWithDefaults)) : yield OAuthMethods.deleteToken(_objectSpread2({
          clientType: "github-app"
        }, optionsWithDefaults));
        yield emitEvent(state, {
          name: "token",
    ...
    function deleteAuthorizationWithState(state, options) {
      return __async(this, null, function* () {
        ...
        const response = state.clientType === "oauth-app" ? yield OAuthMethods.deleteAuthorization(_objectSpread2({
          clientType: "oauth-app"
        }, optionsWithDefaults)) : yield OAuthMethods.deleteAuthorization(_objectSpread2({
          clientType: "github-app"
        }, optionsWithDefaults));
        yield emitEvent(state, {
          name: "token",
...
<p>Your token is: <strong>${token2}</strong>. Copy it now as it cannot be shown again.</p>`
    ...
    function onUnhandledRequestDefaultCloudflare(request) {
      return __async(this, null, function* () {
    ...
    function parseRequest$2(request) {
      ...
      const headers = request.headers;
      const text = () => __async(this, null, function* () {
        return request.body || "";
      });
      return {
        method,
    ...
    function onUnhandledRequestDefaultAWSAPIGatewayV2(event) {
      return __async(this, null, function* () {
  ...
  "node_modules/@octokit/webhooks-methods/dist-node/index.js"(exports) {
    ...
    function verify(secret, eventPayload, signature) {
      return __async(this, null, function* () {
        ...
        const verificationBuffer = buffer.Buffer.from(yield sign({
          secret,
          algorithm
        }, eventPayload));
...
var require_dist_node19 = __commonJS({
  "node_modules/@octokit/webhooks/dist-node/index.js"(exports) {
    ...
    function verifyAndReceive(state, event) {
      return __async(this, null, function* () {
        const matchesSignature = yield webhooksMethods.verify(state.secret, typeof event.payload === "object" ? toNormalizedJsonString(event.payload) : event.payload, event.signature);
        if (!matchesSignature) {
    ...
    function middleware(webhooks, options, request, response, next) {
      return __async(this, null, function* () {
        let pathname;
        try {
...
var require_dist_node20 = __commonJS({
  "node_modules/@octokit/app/dist-node/index.js"(exports) {
    ...
    function middleware(_0, _1, _2, _3, _4) {
      return __async(this, arguments, function* (options, {
        webhooksMiddleware,
        oauthMiddleware
...
// main.ts
__export(exports, {
  default: () => ImageEnhancerPlugin
});
var import_obsidian = __toModule(require("obsidian"));
var import_electron = __toModule(require("electron"));

// node_modules/octokit/dist-web/index.js
var import_core = __toModule(require_dist_node8());
var import_plugin_paginate_rest = __toModule(require_dist_node9());
...
var import_light = __toModule(require_light());
function errorRequest(octokit, state, error, options) {
  return __async(this, null, function* () {
...
var import_light2 = __toModule(require_light());
var VERSION3 = "3.6.2";
var noop = () => Promise.resolve();
function wrapRequest2(state, request, options) {
  return state.retryLimiter.schedule(doRequest, state, request, options);
}
function doRequest(state, request, options) {
  return __async(this, null, function* () {
...
function throttling(octokit, octokitOptions) {
  ...
  state.retryLimiter.on("failed", function(error, info) {
    return __async(this, null, function* () {
      ...
      const { wantRetry, retryAfter = 0 } = yield function() {
        return __async(this, null, function* () {
          if (/\bsecondary rate\b/i.test(error.message)) {
            const retryAfter2 = Math.max(~~error.response.headers["retry-after"], state.minimumSecondaryRateRetryAfter);
            const wantRetry2 = yield emitter.trigger("secondary-limit", retryAfter2, options, octokit);
          ...
          if (error.response.headers != null && error.response.headers["x-ratelimit-remaining"] === "0") {
            ...
            const wantRetry2 = yield emitter.trigger("rate-limit", retryAfter2, options, octokit);
            return { wantRetry: wantRetry2, retryAfter: retryAfter2 };
          }
          return {};
        });
...
// node_modules/octokit/dist-web/index.js
var import_app = __toModule(require_dist_node20());
var import_oauth_app = __toModule(require_dist_node17());
var VERSION4 = "1.7.2";
var Octokit = import_core.Octokit.plugin(restEndpointMethods, import_plugin_paginate_rest.paginateRest, retry, throttling).defaults({
  userAgent: `octokit-rest.js/${VERSION4}`,
  throttle: {
    onRateLimit,
    onAbuseLimit
  }
...
var Github = class {
  ...
  upload(_0) {
    return __async(this, arguments, function* (content, filename = Date.now() + ".png") {
      const res = yield this.client.request(`PUT /repos/${this.owner}/${this.repo}/contents/${filename}`, {
        owner: this.owner,
        repo: this.repo,
        path: filename,
...
var ImageEnhancerPlugin = class extends import_obsidian.Plugin {
  onload() {
    return __async(this, null, function* () {
      ...
      this.addCommand({
        ...
        editorCallback: (editor, view) => __async(this, null, function* () {
          if (this.settings.token === "") {
            new import_obsidian.Notice("GitHub token needed");
            return;
          }
          if (this.settings.owner === "") {
            new import_obsidian.Notice("GitHub owner needed");
            return;
          }
          if (this.settings.repo === "") {
            new import_obsidian.Notice("GitHub repo needed");
            return;
          }
          ...
          const { res, filename } = yield gh.upload(image.toString("base64"));
...
var ImageEnhancerPluginSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Github Token").setDesc("\u4EE4\u724C").addText((text) => text.setPlaceholder("token").setValue(this.plugin.settings.token).onChange((value) => __async(this, null, function* () {
      this.plugin.settings.token = value;
      yield this.plugin.saveSettings();
    })));
    new import_obsidian.Setting(containerEl).setName("owner").setDesc("\u4ED3\u5E93\u7684\u6240\u6709\u8005").addText((text) => text.setPlaceholder("owner").setValue(this.plugin.settings.owner).onChange((value) => __async(this, null, function* () {
      this.plugin.settings.owner = value;
      yield this.plugin.saveSettings();
    })));
    new import_obsidian.Setting(containerEl).setName("repo").setDesc("\u5B58\u653E\u56FE\u7247\u7684\u4ED3\u5E93\u540D").addText((text) => text.setPlaceholder("repo").setValue(this.plugin.settings.repo).onChange((value) => __async(this, null, function* () {
